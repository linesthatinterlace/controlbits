...
lemma flipBit_succ {q : BV (m + 2)} : flipBit (i.succ) q = mergeBitRes 0 (getBit 0 q) (flipBit i (getRes 0 q)) := by
...
lemma getRes_zero_eq_and_getBit_zero_opp_of_lt_of_flipBit_gt {r : BV (m + 1)} (h : r < q)
